...
shadowOffset[iOS]: {
    width: shadow offset in x-axix
    height: shadow offset in y-axix
},
shadowOpacity[iOS]: Sets the drop shadow opacity 
shadowRadius[iOS]: sets the drop shadow blur radius 
*/
