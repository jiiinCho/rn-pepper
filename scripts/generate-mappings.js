...
const relative = (value) => path.relative(root, path.resolve(path.dirname(index), value));
...
fs.writeFileSync(output, JSON.stringify({ name: packageJson.name, index, mappings }, null, 2));
